...
* Press the highlighated notes to play without a midi keyboard.
1. Press 'Q' to transpose the notes from keyboard down an octave.
2. Press 'W' to transpose the notes from keyboard up an octave.
